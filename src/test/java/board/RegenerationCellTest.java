...
class RegenerationCellTest {
    ...
    private WeaponCard weapon1 = new SimpleWeapon(EnumSimpleWeapon.ELECTROSCYTHE);
    private WeaponCard weapon2 = new SimpleWeapon(EnumSimpleWeapon.LOCK_RIFLE);
    private WeaponCard weapon3 = new SimpleWeapon(EnumSimpleWeapon.MACHINE_GUN);
