...
public enum EnumAttackName {
    ...
    MACHINE_GUN_OP1("With focus shot","Deal 1 additional damage to one of those targets."),
    MACHINE_GUN_OP2("With turret tripod","Deal 1 additional damage to the other od those targets and/or deal 1 damage to a different target you can see."),
